...
const SwapSkeleton = () => {
  return (
    <div
      className={`flex flex-col justify-center items-center p-4 gap-4 backdrop-blur-sm rounded-3xl bg-opacity-0 max-w-[404px] w-screen`}
    >
      <div className="relative flex flex-col gap-2 w-full">
        ...
        <div className="h-6 w-6 rounded-full border border-white-100 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 animate-pulse" />
