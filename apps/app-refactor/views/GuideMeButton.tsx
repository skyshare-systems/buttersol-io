...
import GuideMe from "public/icons/swap/help-square.svg";
...
const GuideMeButton = () => {
  ...
  return (
    <div
      className="fixed bottom-5 right-5 hidden lg:block text-white-100 z-[50] group"
      onClick={() => handleClickStep()}
    >
      <button className="relative rounded-2xl p-4 flex items-center gap-2 border border-white-16 bg-white-8  w-14 h-14 transition-all duration-150 ease-in-out hover:w-[135px]">
